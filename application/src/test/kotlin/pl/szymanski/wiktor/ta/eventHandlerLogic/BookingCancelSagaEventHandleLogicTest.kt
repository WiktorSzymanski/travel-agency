...
//            EventEnvelope(
//                BookingCancelSagaStartedEvent(bookingId = bookingId.value!!),
...
//            EventEnvelope(
//                BookingCancelSagaCompletedEvent(bookingId = bookingId.value!!, seat = AnySeat),
//                Metadata(correlationId, 0)
//            )
//        )
//
...
//            EventEnvelope(
//                BookingCancelSagaFailedEvent(bookingId = bookingId.value!!, message = message),
//                Metadata(correlationId, 0)
//            )
//        )
//
