...
class TravelOfferCommandHandlerTest {
    ...
    @Test
    fun `handle CreateTravelOfferCommand should delegate to TravelOffer_create`() = runTest {
        // Given
    ...
    @Test
    fun `handle ReserveTravelOfferCommand should call travelOffer_reserve`() = runTest {
        // Given
        val command = ReserveTravelOfferCommand(
            travelOfferId = UUID.randomUUID(),
            correlationId = UUID.randomUUID(),
    ...
    @Test
    fun `handle CancelReserveTravelOfferCommand should call travelOffer_cancelReservation`() = runTest {
        // Given
        val command = CancelReserveTravelOfferCommand(
            travelOfferId = UUID.randomUUID(),
            correlationId = UUID.randomUUID(),
            bookingId = UUID.randomUUID(),
            seat = Seat("1", "B"),
    ...
    @Test
    fun `handle BookTravelOfferCommand should call travelOffer_book`() = runTest {
        // Given
        val command = BookTravelOfferCommand(
            travelOfferId = UUID.randomUUID(),
            correlationId = UUID.randomUUID(),
            bookingId = UUID.randomUUID(),
            seat = Seat("2", "A"),
    ...
    @Test
    fun `handle CancelBookTravelOfferCommand should call travelOffer_cancelBooking`() = runTest {
        // Given
        val command = CancelBookTravelOfferCommand(
            travelOfferId = UUID.randomUUID(),
            correlationId = UUID.randomUUID(),
            bookingId = UUID.randomUUID(),
            seat = Seat("2", "B"),
    ...
    @Test
    fun `handle ReleaseTravelOfferCommand should call travelOffer_releaseBooking`() = runTest {
        // Given
        val command = ReleaseTravelOfferCommand(
            travelOfferId = UUID.randomUUID(),
            correlationId = UUID.randomUUID(),
            bookingId = UUID.randomUUID(),
            seat = Seat("3", "A"),
    ...
    @Test
    fun `handle RebookTravelOfferCommand should call travelOffer_rebook`() = runTest {
        // Given
        val command = RebookTravelOfferCommand(
            travelOfferId = UUID.randomUUID(),
            correlationId = UUID.randomUUID(),
            bookingId = UUID.randomUUID(),
        )
    ...
    @Test
    fun `handle ExpireTravelOfferCommand should call travelOffer_expire`() = runTest {
        // Given
        val command = ExpireTravelOfferCommand(
            travelOfferId = UUID.randomUUID(),
            correlationId = UUID.randomUUID(),
        )
    ...
    @Test
    fun `handle MakeTravelOfferAvailableCommand should call travelOffer_makeAvailable`() = runTest {
        // Given
        val command = MakeTravelOfferAvailableCommand(
            travelOfferId = UUID.randomUUID(),
            correlationId = UUID.randomUUID(),
        )
    ...
    @Test
    fun `handle MakeTravelOfferUnavailableCommand should call travelOffer_makeUnavailable`() = runTest {
        // Given
        val command = MakeTravelOfferUnavailableCommand(
            travelOfferId = UUID.randomUUID(),
            correlationId = UUID.randomUUID(),
        )
