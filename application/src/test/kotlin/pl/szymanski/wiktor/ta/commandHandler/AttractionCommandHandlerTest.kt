...
class AttractionCommandHandlerTest {
    ...
    @Test
    fun `handle CreateAttractionCommand should delegate to Attraction_create`() = runTest {
        // Given
    ...
    @Test
    fun `handle BookAttractionCommand should call attraction_book`() = runTest {
        // Given
        val command = BookAttractionCommand(
            attractionId = UUID.randomUUID(),
            correlationId = UUID.randomUUID(),
    ...
    @Test
    fun `handle CancelAttractionBookingCommand should call attraction_cancelBooking`() = runTest {
        // Given
        val command = CancelAttractionBookingCommand(
            attractionId = UUID.randomUUID(),
            correlationId = UUID.randomUUID(),
            bookingId = UUID.randomUUID(),
        )
    ...
    @Test
    fun `handle ExpireAttractionCommand should call attraction_expire`() = runTest {
        // Given
        val command = ExpireAttractionCommand(
            attractionId = UUID.randomUUID(),
            correlationId = UUID.randomUUID(),
        )
