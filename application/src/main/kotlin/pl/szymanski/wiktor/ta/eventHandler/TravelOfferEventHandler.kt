...
class TravelOfferEventHandler(
    ...
    suspend fun commuteExpiredEventHandler() = coroutineScope {
    ...
    suspend fun accommodationExpiredEventHandler() = coroutineScope {
    ...
    suspend fun attractionExpiredEventHandler() = coroutineScope {
